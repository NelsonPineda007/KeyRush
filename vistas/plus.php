...
<head>
    ...
    <link rel="stylesheet" href="../css/plus1.css">
    <title>KeyRush</title>
</head>
<body>
...
<!-- Plan Basic -->
<div class="bg-white border-2 border-gray-500 rounded-2xl p-8 transition-all duration-300 hover:border-gray-400 hover:shadow-2xl hover:shadow-gray-500/30 group h-full flex flex-col">

    <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-gray-400 to-gray-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
    
    <div class="text-center mb-6">
        <div class="inline-block bg-gray-600 p-4 rounded-2xl shadow-lg mb-4">
            <i class="fas fa-star text-4xl text-white"></i>
        </div>
        <h3 class="text-3xl font-bold text-gray-800 mb-2">KeyRush Basic</h3>
        <p class="text-gray-600 mb-4">Para comenzar tu aventura</p>
        <div class="mb-2">
            <span class="text-5xl font-bold text-gray-800">$4.99</span>
            <span class="text-gray-600">/mes</span>
        </div>
        <p class="text-sm text-gray-500">o $49.99/año (ahorra 17%)</p>
    </div>
    
    <div class="space-y-3 mb-8">
        <div class="flex items-center gap-3 text-gray-700">
            <i class="fas fa-check-circle text-gray-600 text-lg flex-shrink-0"></i>
            <span>5% descuento en todas las compras</span>
        </div>
        <div class="flex items-center gap-3 text-gray-700">
            <i class="fas fa-check-circle text-gray-600 text-lg flex-shrink-0"></i>
            <span>Acceso a ofertas flash</span>
        </div>
        <div class="flex items-center gap-3 text-gray-700">
            <i class="fas fa-check-circle text-gray-600 text-lg flex-shrink-0"></i>
            <span>Notificaciones de juegos gratis</span>
        </div>
        <div class="flex items-center gap-3 text-gray-700">
            <i class="fas fa-check-circle text-gray-600 text-lg flex-shrink-0"></i>
        ...
        <div class="flex items-center gap-3 text-gray-700">
            <i class="fas fa-check-circle text-gray-600 text-lg flex-shrink-0"></i>
            <span>Insignia de miembro Basic</span>
        </div>
    ...
    <!-- Botón con id -->
<div class="mt-auto flex justify-center items-end">
  <div
    class="wompi_button_widget"
    data-url-pago="https://pagos.wompi.sv/IntentoPago/Redirect?id=b737561a-70ff-49cf-ae79-a2761908de8b&esWidget=1"
    data-render="widget">
  </div>
</div>
...
<div class="bg-white border-2 border-[#5BC0FF] rounded-2xl p-8 transition-all duration-300 hover:border-[#5BC0FF] hover:shadow-2xl hover:shadow-[#5BC0FF]/30 group h-full flex flex-col">


                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#5BC0FF] to-[#00D4FF] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>

                <div class="text-center mb-6 mt-4">
                    <div class="inline-block bg-gradient-to-r from-[#5BC0FF] to-[#00D4FF] p-4 rounded-2xl shadow-lg mb-4">
                        <i class="fas fa-gem text-4xl text-white"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-gray-800 mb-2">KeyRush Pro</h3>
                    <p class="text-gray-600 mb-4">El equilibrio perfecto</p>
                    <div class="mb-2">
                        <span class="text-5xl font-bold text-gray-800">$9.99</span>
                        <span class="text-gray-600">/mes</span>
                    </div>
                    <p class="text-sm text-gray-500">o $99.99/año (ahorra 17%)</p>
                </div>
                
                <div class="space-y-3 mb-8">
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span><strong>15% descuento</strong> en todas las compras</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span>Acceso 24h antes a ofertas</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span>3 juegos gratis al mes</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span>Reembolso extendido (30 días)</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                    ...
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span>Acceso a beta de productos</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#5BC0FF] text-lg flex-shrink-0"></i>
                        <span>Insignia de miembro Pro</span>
                    </div>
                </div>
...
<div class="mt-auto flex justify-center items-end">
  <div
    ...
    data-render="widget">
            ...
            <!-- Plan Elite -->
<div class="bg-white border-2 border-[#FFD700] rounded-2xl p-8 transition-all duration-300 hover:border-[#FFD700] hover:shadow-2xl hover:shadow-[#FFD700]/30 group h-full flex flex-col">

                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#FFD700] to-[#FFA500] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                
                <div class="text-center mb-6">
                    <div class="inline-block bg-gradient-to-r from-[#FFD700] to-[#FFA500] p-4 rounded-2xl shadow-lg mb-4">
                        <i class="fas fa-crown text-4xl text-white"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-gray-800 mb-2">KeyRush Elite</h3>
                    <p class="text-gray-600 mb-4">Experiencia VIP completa</p>
                    <div class="mb-2">
                        <span class="text-5xl font-bold text-gray-800">$19.99</span>
                        <span class="text-gray-600">/mes</span>
                    </div>
                    <p class="text-sm text-gray-500">o $199.99/año (ahorra 17%)</p>
                </div>
                
                <div class="space-y-3 mb-8">
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span><strong>25% descuento</strong> en todas las compras</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Acceso 48h antes a ofertas</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>5 juegos AAA gratis al mes</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Reembolso extendido (60 días)</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Gestor de cuenta personal</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Acceso exclusivo a lanzamientos</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Eventos VIP y sorteos exclusivos</span>
                    </div>
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                    ...
                    <div class="flex items-center gap-3 text-gray-700">
                        <i class="fas fa-check-circle text-[#FFD700] text-lg flex-shrink-0"></i>
                        <span>Insignia de miembro Elite</span>
                    </div>
                </div>
...
<div class="mt-auto flex justify-center items-end">
  <div
    ...
    data-render="widget">
        ...
        <div class="bg-gradient-to-r from-[#14142e]/80 to-[#1e1e32]/60 border border-[#5BC0FF]/20 rounded-2xl p-12 backdrop-blur-lg">
            <h2 class="text-3xl font-bold text-white text-center mb-8">
                <i class="fas fa-gift text-[#5BC0FF] mr-3"></i>
                Beneficios para Todos los Miembros
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="bg-[#5BC0FF]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-shield-alt text-3xl text-[#5BC0FF]"></i>
                    </div>
                    <h3 class="text-white font-semibold mb-2">Compra Segura</h3>
                    <p class="text-gray-400 text-sm">Protección en todas tus transacciones</p>
                </div>
                <div class="text-center">
                    <div class="bg-[#5BC0FF]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-truck text-3xl text-[#5BC0FF]"></i>
                    </div>
                    <h3 class="text-white font-semibold mb-2">Entrega Instantánea</h3>
                    <p class="text-gray-400 text-sm">Recibe tus keys al momento</p>
                </div>
                <div class="text-center">
                    <div class="bg-[#5BC0FF]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-headset text-3xl text-[#5BC0FF]"></i>
                    </div>
                    <h3 class="text-white font-semibold mb-2">Soporte 24/7</h3>
                    <p class="text-gray-400 text-sm">Siempre disponibles para ayudarte</p>
                </div>
                <div class="text-center">
                    <div class="bg-[#5BC0FF]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-medal text-3xl text-[#5BC0FF]"></i>
                    </div>
                    <h3 class="text-white font-semibold mb-2">Recompensas</h3>
                    <p class="text-gray-400 text-sm">Gana puntos con cada compra</p>
                </div>
            </div>
        </div>
