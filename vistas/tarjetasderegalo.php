...
<head>
    ...
    <link rel="stylesheet" href="../css/tarjetasderegalo.css">
    <title>KeyRush</title>
</head>
<body>
    ...
    <nav class="navbar-bg">
        ...
        <div class="py-2 px-6">
            <div class="flex justify-center space-x-8">
                ...
                <!-- Suscripciones -->
                <a href="../vistas/suscripciones.php" class="nav-item flex items-center py-2 px-4 text-white hover:text-[#5BC0FF]">
